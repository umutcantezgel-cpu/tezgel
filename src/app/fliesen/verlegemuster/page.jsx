...
export default function VerlegemusterPage() {
    return (
        <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10" aria-labelledby="vm-ratgeber-heading">
                <div className="glass-surface-subtle rounded-tile-xl p-6 sm:p-8">
                    <h2 id="vm-ratgeber-heading" className="text-lg font-black text-slate-900 mb-4">Weiterführende Ratgeber zu Verlegemustern &amp; Fugenbildern</h2>
