...
export const metadata = createMetadata({
    ...
    description:
        'Tragfähig, eben, trocken, dicht: Wie der Meisterbetrieb Untergründe für Fliesen prüft und vorbereitet – von der DIN-18534-Abdichtung bis zur Entkopplung.',
        ...
        <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
                    ...
                    {SUBPAGES.map((page) => {
                        ...
                        return (
                            <li key={page.path}>
                                <Link
                                    href={page.path}
                                    className="group glass-surface p-6 rounded-[2rem] h-full flex flex-col hover:-translate-y-0.5 hover:border-emerald-500/80 hover:shadow-[0_20px_40px_-12px_rgba(15,23,42,0.14)] transition-all duration-300"
                                >
                                    <span className="icon-chip w-11 h-11 mb-4">
                                        <Icon className="w-5 h-5" />
                                    </span>
                                    <span className="font-black text-base text-slate-900 group-hover:text-emerald-800 transition-colors mb-1">
                                        {page.name}
                                    </span>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10" aria-labelledby="schaeden-heading">
                <div className="text-center max-w-3xl mx-auto mb-12">
                    <span className="eyebrow eyebrow-sky mb-4">Ursachen</span>
                    ...
                    <ol className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
                        {CRITERIA.map((item, idx) => (
                            <li key={item.title} className="p-6 rounded-3xl bg-slate-50 border border-slate-200">
                                <span className="font-display block text-4xl font-black tabular-nums text-emerald-600/30 mb-3" aria-hidden="true">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10" aria-label="Themen im Überblick">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <article id="din18534" className="glass-surface rounded-[2rem] p-7 sm:p-9 scroll-mt-28">
                        <span className="icon-chip w-11 h-11 mb-4">
                    ...
                    <article id="abbruch" className="glass-surface rounded-[2rem] p-7 sm:p-9 scroll-mt-28">
                        <span className="icon-chip w-11 h-11 mb-4">
                        ...
                        <Link href="/untergrund-abdichtung/fliesen-auf-fliesen" className="mt-4 inline-flex items-center gap-1 text-sm font-bold text-emerald-800 hover:text-emerald-700">
                            Fliesen auf Fliesen oder Rückbau?
                            <ArrowRight className="w-4 h-4" />
                        </Link>
                    </article>

                    <article id="ausgleich" className="glass-surface rounded-[2rem] p-7 sm:p-9 scroll-mt-28">
                        <span className="icon-chip w-11 h-11 mb-4">
                        ...
                        <Link href="/untergrund-abdichtung/ausgleich-gefaelle" className="mt-4 inline-flex items-center gap-1 text-sm font-bold text-emerald-800 hover:text-emerald-700">
                            Ausgleich &amp; Gefälle im Detail
                            <ArrowRight className="w-4 h-4" />
                        </Link>
                    </article>

                    <article id="rissverharzung" className="glass-surface rounded-[2rem] p-7 sm:p-9 scroll-mt-28">
                        <span className="icon-chip w-11 h-11 mb-4">
                        ...
                        <Link href="/untergrund-abdichtung/entkopplung" className="mt-4 inline-flex items-center gap-1 text-sm font-bold text-emerald-800 hover:text-emerald-700">
            ...
            <section className="py-20 bg-white border-y border-slate-200 relative z-10" aria-labelledby="untergruende-heading">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <span className="eyebrow eyebrow-sky mb-4">Typische Untergründe</span>
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {SUBSTRATES.map((item) => (
                            <li key={item.title}>
                                <Link
                                    href={item.href}
                                    className="group flex gap-4 p-6 rounded-3xl bg-slate-50 border border-slate-200 h-full hover:bg-white hover:-translate-y-0.5 hover:border-emerald-500/80 transition-all duration-300"
                                >
                                    <CircleCheck className="w-6 h-6 text-emerald-600 shrink-0 mt-0.5" />
                                    <span>
                                        <span className="block font-black text-base text-slate-900 mb-1 group-hover:text-emerald-800 transition-colors">
                                            {item.title}
                                        </span>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 relative z-10" aria-labelledby="aufmass-heading">
                <div className="ceramic-hero rounded-[2.5rem] p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
                    ...
                    <div className="lg:col-span-2 flex flex-col sm:flex-row lg:flex-col gap-3">
                        ...
                        <a
                            ...
                            className="btn-ghost px-7 py-3.5 text-xs w-full justify-center"
                        >
