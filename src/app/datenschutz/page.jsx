...
export const metadata = {
    title: 'Datenschutzerklärung | Fliesenverlegung Tezgel Aßlar',
    ...
    alternates: { canonical: 'https://tezgel.de/datenschutz' }
};
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="glass-surface-dark rounded-[2.5rem] p-8 sm:p-12 border border-white/15 shadow-2xl space-y-8 text-slate-300">
                    ...
                    <div>
                        ...
                        <h1 className="text-3xl sm:text-4xl font-black text-white mt-1">Datenschutzerklärung</h1>
                    </div>

                    {/* 1. Datenschutz auf einen Blick */}
                    <div className="space-y-3 text-xs sm:text-sm text-slate-300 leading-relaxed border-b border-white/10 pb-6">
                        <h2 className="text-base font-black text-white">1. Datenschutz auf einen Blick</h2>
                        <h3 className="font-bold text-emerald-400 text-sm">Allgemeine Hinweise</h3>
                        <p>
                            Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie unsere Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.
                        </p>
                        <h3 className="font-bold text-emerald-400 text-sm pt-2">Datenerfassung auf dieser Website</h3>
                        <p>
                            <strong>Wer ist verantwortlich für die Datenerfassung auf dieser Website?</strong><br />
                            Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber: Deniz Tezgel, Fliesenverlegung Tezgel, Hohwardstraße 14, 35614 Aßlar.
                        </p>
                        <p>
                    ...
                    <div className="space-y-2 text-xs sm:text-sm text-slate-300 leading-relaxed border-b border-white/10 pb-6">
                        <h2 className="text-base font-black text-white">2. Hinweis zur verantwortlichen Stelle</h2>
                        <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
                        <div className="p-5 bg-white/[0.04] rounded-2xl border border-white/10 text-slate-200">
                            <p className="font-bold text-white text-base">Fliesenverlegung Tezgel</p>
                            <p>Inhaber: Deniz Tezgel</p>
                            <p>{COMPANY_DATA.headquarters.street}</p>
                            <p>{COMPANY_DATA.headquarters.postalCode} {COMPANY_DATA.headquarters.city}</p>
                            <p className="pt-2">Telefon: {COMPANY_DATA.contact.phone}</p>
                            <p>Mobilfunk / WhatsApp: {COMPANY_DATA.contact.mobile}</p>
                    ...
                    <div className="space-y-3 text-xs sm:text-sm text-slate-300 leading-relaxed border-b border-white/10 pb-6">
                        <h2 className="text-base font-black text-white">3. Lokale Schriften (Next.js Font Optimization)</h2>
                        <p>
                            Diese Website nutzt zur einheitlichen Darstellung von Schriftarten lokale Schriften, die über die Next.js Font-Pipeline bereitgestellt werden. Beim Aufruf einer Seite lädt Ihr Browser die benötigten Schriftdateien direkt von unserem Webserver. Es wird <strong>keine</strong> Verbindung zu externen Servern von Drittanbietern (wie Google Fonts) aufgebaut und keine IP-Adresse dorthin übertragen.
                        </p>
                    </div>

                    {/* 4. WhatsApp-Kommunikation */}
                    <div className="space-y-3 text-xs sm:text-sm text-slate-300 leading-relaxed border-b border-white/10 pb-6">
                        <h2 className="text-base font-black text-white">4. Kontaktaufnahme via WhatsApp</h2>
                        <p>
                            Wir bieten Ihnen die Möglichkeit, über die Anwendung &bdquo;WhatsApp&ldquo; schnell und unkompliziert Kontakt mit Herrn Deniz Tezgel aufzunehmen. Anbieter von WhatsApp ist die WhatsApp Ireland Limited, 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland.
                        </p>
                        <p>
                            Die Nutzung erfolgt auf rein freiwilliger Basis (Art. 6 Abs. 1 lit. a DSGVO). Wenn Sie auf einen WhatsApp-Button klicken, öffnet sich die WhatsApp-Anwendung auf Ihrem Endgerät oder WhatsApp Web. Die Datenübertragung (Telefonnummer, Nachrichtentext) erfolgt direkt zwischen Ihnen und uns über die Ende-zu-Ende-Verschlüsselung von WhatsApp. Details zum Datenschutz bei WhatsApp finden Sie unter: <a href="https://www.whatsapp.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#25D366] underline">https://www.whatsapp.com/legal/privacy-policy</a>.
                        </p>
                    </div>

                    {/* 5. Ihre Rechte */}
                    <div className="space-y-3 text-xs sm:text-sm text-slate-300 leading-relaxed border-b border-white/10 pb-6">
                        <h2 className="text-base font-black text-white">5. Ihre Rechte als betroffene Person</h2>
                        ...
                        <h3 className="font-bold text-white text-sm pt-2">Beschwerderecht bei der Aufsichtsbehörde:</h3>
                        <p className="text-slate-400">
                            Der Hessische Beauftragte für Datenschutz und Informationsfreiheit<br />
                            Gustav-Stresemann-Ring 1, 65189 Wiesbaden<br />
                            Website: <a href="https://datenschutz.hessen.de" target="_blank" rel="noopener noreferrer" className="text-emerald-400 underline">https://datenschutz.hessen.de</a>
                        </p>
                    </div>

                    <div className="pt-4 border-t border-white/10 flex justify-between items-center text-xs">
                        <Link href="/" className="text-emerald-400 hover:underline">&larr; Zurück zur Startseite</Link>
                        <Link href="/impressum" className="text-slate-400 hover:text-white">Zum Impressum &rarr;</Link>
                    </div>
