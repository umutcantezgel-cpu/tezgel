...
export default function InnentreppePage() {
    ...
    return (
        <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 relative z-10" aria-labelledby="innentreppe-ratgeber-heading">
                <h2 id="innentreppe-ratgeber-heading" className="text-2xl font-black text-slate-900 tracking-tight mb-6">
                    Weiterführende Ratgeber zu Innentreppen &amp; Fliesenbelägen
                </h2>
