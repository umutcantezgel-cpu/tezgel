...
const HIGHLIGHTS = [
    { icon: Award, title: 'Eingetragener Meisterbetrieb', desc: `Handwerk nach geprüften Standards – eingetragen bei der ${authority.name} als ${authority.responsibility}.` },
...
const JOBS = [
    ...
    },
    {
        ...
        loc: `${headquarters.city} & Mittelhessen`,
        desc: `Lerne das Fliesenhandwerk von Grund auf in einem eingetragenen Meisterbetrieb der ${authority.shortName}.`,
        ...
        <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 relative z-10">
                <div className="ceramic-hero rounded-[3rem] p-8 sm:p-12 text-center space-y-4 relative overflow-hidden">
                    ...
                    <p className="text-sm sm:text-base text-slate-700 max-w-2xl mx-auto leading-relaxed">
                        Wir suchen Verstärkung im Fliesenhandwerk: Fliesenleger (m/w/d) – Geselle oder Meister. Bewerben Sie sich direkt bei Inhaber {COMPANY_DATA.owner.fullName} – per E-Mail, Telefon oder WhatsApp.
                    </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-10">
                    <span className="eyebrow eyebrow-sky mb-4">Arbeiten im Meisterbetrieb</span>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
                    {HIGHLIGHTS.map(({ icon: Icon, title, desc }) => (
                        ...
                        >
                            ...
                            <h3 className="font-black text-base text-slate-900 mb-2 group-hover:text-emerald-800 transition-colors">{title}</h3>
                ...
                <div className="space-y-6 max-w-4xl mx-auto">
                    ...
                    {JOBS.map((job) => (
                        <article
                            key={job.title}
                            className="glass-surface p-8 rounded-[2rem] flex flex-col sm:flex-row sm:items-center justify-between gap-6 hover:-translate-y-0.5 hover:border-emerald-500/80 hover:shadow-[0_20px_40px_-12px_rgba(15,23,42,0.14)] transition-all duration-300"
                        >
                            <div>
                                <span className="text-xs font-black text-emerald-800 bg-emerald-50 px-3.5 py-1 rounded-full inline-flex items-center gap-1.5 mb-2 border border-emerald-200">
                                ...
                                {job.moreHref && (
                                    <Link
                                        href={job.moreHref}
                                        className="mt-3 inline-flex items-center gap-1.5 text-sm font-bold text-emerald-800 hover:text-emerald-700 hover:underline underline-offset-2"
                                    >
