        ...
        <section className="py-20 sm:py-24 relative overflow-hidden" aria-labelledby="quality-promise-heading">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-14">
                    ...
                    <h2 id="quality-promise-heading" className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight leading-tight">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    {COMPANY_DATA.qualityPromises.map((promise, idx) => {
                        ...
                        return (
                            <li
                                key={promise.title}
                                className="glass-surface rounded-3xl p-6 group flex flex-col justify-between hover:-translate-y-0.5 hover:border-emerald-500/80 hover:shadow-[0_20px_40px_-12px_rgba(15,23,42,0.14)] transition-all duration-300"
                            >
                                <div>
                                    ...
                                    <h3 className="text-base font-black text-slate-900 mt-1 mb-2 leading-snug group-hover:text-emerald-800 transition-colors">
                                        {promise.title}
                                    </h3>
                                    <p className="text-sm text-slate-700 leading-relaxed">{promise.description}</p>
                                </div>
                                <p className="mt-5 pt-3 border-t border-slate-200 flex items-center gap-1.5 text-xs font-bold text-emerald-800">
                ...
                <div className="ceramic-hero mt-12 rounded-[2rem] p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
